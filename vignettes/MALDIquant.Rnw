...
\title{\Rpackage{MALDIquant}: Quantitative Analysis of Mass Spectrometry Data}
...
\Mq{} is free and open source software for the \R{} \citep{RPROJECT} environment
