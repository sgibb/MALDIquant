...
test_that("movingAverage throws errors", {
  expect_error(movingAverage(1:10, halfWindowSize=0), "too small")
  expect_error(movingAverage(1:10, halfWindowSize=100), "too large")
})
...
test_that("savitzkyGolay", {
  expect_equal(savitzkyGolay(1:10, halfWindowSize=2, polynomialOrder=0),
               movingAverage(1:10, halfWindowSize=2))
  ...
  expect_equal(savitzkyGolay(values, halfWindowSize=2, polynomialOrder=3),
               result)
})

test_that("savitzkyGolay throws errors", {
  expect_error(savitzkyGolay(1:10, halfWindowSize=0, polynomialOrder=3), "too small")
  expect_error(savitzkyGolay(1:10, halfWindowSize=100, polynomialOrder=3), "too large")
  expect_error(savitzkyGolay(1:10, halfWindowSize=2, polynomialOrder=10),
