...
test_that("determineWarpingFunctions supports allowNoMatch argument", {
  suppressWarnings(
    w <- determineWarpingFunctions(
        list(p, createMassPeaks(11, 11), p), reference=r, allowNoMatch=TRUE)
  )
